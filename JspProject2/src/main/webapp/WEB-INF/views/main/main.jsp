	...
	<main role="main">
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="carousel-item">
					<img src="resources/sample_img/main_wide_pic.jpg" class="first-slide"  alt="First slide">
					<div class="container">
				...
				<div class="carousel-item">
					<img src="resources/sample_img/main_wide_pic2.jpg" class="second-slide" alt="Second slide">
					<div class="container">
				...
				<div class="carousel-item active">
					<img src="resources/sample_img/main_wide_pic3.jpg" class="third-slide" alt="Third slide">
					<div class="container">
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				...
				<div class="col-md-5" id="icicic">
					<img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" style="width: 500px; height: 500px;" src="resources/sample_img/main_collection7-1.jpg" data-holder-rendered="true">4
				</div>
			</div>
			...
			<div class="row featurette">
				...
				<div class="col-md-5 order-md-1">
					<img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="resources/sample_img/main_collection8-1.jpg" data-holder-rendered="true" style="width: 500px; height: 500px;">
				</div>
			</div>
			...
			<div class="row featurette">
				...
				<div class="col-md-5">
					<img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="resources/sample_img/main_collection2.jpg" data-holder-rendered="true" style="width: 500px; height: 500px;">
				</div>
			</div>
